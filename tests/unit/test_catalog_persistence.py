...
def test_schema_v4_migrates_phase2_data_without_rewriting_it(tmp_path: Path) -> None:
...
def test_schema_v4_upgrades_an_existing_phase3_database(tmp_path: Path) -> None:
